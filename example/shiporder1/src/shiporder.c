...
static const xs_element_t shiporder_descendant[] =
{
    ...
    [2].Callback    = itemCallback,                     //!< Callback to be called after parsing of an element
    [2].Target.Type    = EN_RELATIVE,                   //!< Target address type is relative.
    [2].Target.Offset  = offsetof(shiporder_t, item),   //!< Target address offset from the parent target address
    [2].Target.Size    = sizeof(item_t),                //!< This element doesn't hold any content.
